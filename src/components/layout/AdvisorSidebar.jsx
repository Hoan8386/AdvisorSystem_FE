...
export const AdvisorSidebar = ({ onClose, isCollapsed = false, onToggle }) => {
  ...
  return (
    <div
      ...
      } h-screen bg-gradient-to-b from-[#1da1f2] via-[#1890da] to-[#1780c8] shadow-2xl flex flex-col relative overflow-hidden rounded-r-3xl transition-all duration-300`}
    >
      {/* Decorative Elements */}
      <div
          ...
          return (
            ...
            >
              ...
              {isActive && !isCollapsed && (
                <div className="absolute left-0 top-1/2 -translate-y-1/2 w-1 h-8 bg-gradient-to-b from-[#1da1f2] to-[#096dd9] rounded-r-full" />
              )}
              ...
              <div
                className={`w-10 h-10 rounded-xl flex items-center justify-center transition-all duration-300 ${
                  isActive
                    ? "bg-gradient-to-br from-[#1da1f2] to-[#096dd9] shadow-lg"
              ...
              {!isCollapsed && (
                <>
                  ...
                  {/* Arrow indicator */}
                  {isActive && (
                    <div className="w-2 h-2 rounded-full bg-[#1da1f2] animate-pulse" />
                  )}
                </>
              )}
            </button>
